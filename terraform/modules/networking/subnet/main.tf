resource "aws_subnet" "private_us_east_2a" {
  ...
  tags = {
    "Name"                            = "private-us-east-2a-${var.environment}"
...
resource "aws_subnet" "private_us_east_2b" {
  ...
  tags = {
    "Name"                            = "private-us-east-2b-${var.environment}"
    "kubernetes.io/role/internal-elb" = "1"
    "kubernetes.io/cluster/${var.environment}"      = "owned"
    "kubernetes.io/cluster/teraops-${var.environment}" = "shared"
  }
...
resource "aws_subnet" "public_us_east_2a" {
  ...
  tags = {
    "Name"                       = "public-us-east-2a-${var.environment}"
...
resource "aws_subnet" "public_us_east_2b" {
  ...
  tags = {
    "Name"                       = "public-us-east-2b-${var.environment}"
    "kubernetes.io/role/elb"     = "1"
    "kubernetes.io/cluster/${var.environment}" = "owned"
    "kubernetes.io/cluster/teraops-${var.environment}" = "shared"
  }
